...
function register_customize_widgets_pro( $widgets_manager ) {
    ...
    $el_widgets = array('vertical-navigation'=>esc_html__('Vertical Menu','customize-my-account-for-woocommerce-pro'),
                        'horizontal-navigation'=>esc_html__('Horizontal Menu','customize-my-account-for-woocommerce-pro'),
                        'my-orders'=>esc_html__('My Orders','customize-my-account-for-woocommerce-pro'),
